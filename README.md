# Guayaba Documentation

**Guayaba** is a platform for deploying and managing AI agents. Create agents powered by any LLM, connect them to Telegram, give them skills and tools, and interact with them through a web UI or programmatic API.
...
- **Collaborate in shared organizations** — invite teammates, share billing and agents inside an organization.
...
[https://app.guayaba.run](https://app.guayaba.run)
